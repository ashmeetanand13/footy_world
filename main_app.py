...
from streamlit_data_loader import data_loader_ui, load_sample_data
        ...
        if "Pos" in filtered_players.columns:
            ...
            performance_metric = st.selectbox(
                ...
                options=[
                    ...
                    "Total Cmp%", "PrgP", "Carries PrgC"
                ],
                index=0
            )
            
            if performance_metric in filtered_players.columns:
...
1. Upload your football league data using the interface on the left
2. Select specific leagues to compare using the dropdown menu
3. Navigate through the tabs to explore different aspects of playing styles
4. Use the visualizations to identify patterns and differences between leagues
5. Enable the position-based analysis for more detailed insights (if player data is available)

**Note**: Currently using sample data. Please upload your complete dataset for accurate analysis.
""")
